...
public class ClpSerializer {
	...
	public static Throwable translateThrowable(Throwable throwable) {
		...
		if (className.equals(
					"com.liferay.docs.guestbook.exception.EntryEmailException")) {
			return new com.liferay.docs.guestbook.exception.EntryEmailException(throwable.getMessage(),
				throwable.getCause());
		}

		if (className.equals(
					"com.liferay.docs.guestbook.exception.EntryMessageException")) {
			return new com.liferay.docs.guestbook.exception.EntryMessageException(throwable.getMessage(),
				throwable.getCause());
		}

		if (className.equals(
					"com.liferay.docs.guestbook.exception.EntryNameException")) {
			return new com.liferay.docs.guestbook.exception.EntryNameException(throwable.getMessage(),
				throwable.getCause());
		}

		if (className.equals(
					"com.liferay.docs.guestbook.exception.GuestbookNameException")) {
			return new com.liferay.docs.guestbook.exception.GuestbookNameException(throwable.getMessage(),
				throwable.getCause());
		}

		if (className.equals(
					"com.liferay.docs.guestbook.exception.NoSuchEntryException")) {
			return new com.liferay.docs.guestbook.exception.NoSuchEntryException(throwable.getMessage(),
				throwable.getCause());
		}

		if (className.equals(
					"com.liferay.docs.guestbook.exception.NoSuchGuestbookException")) {
			return new com.liferay.docs.guestbook.exception.NoSuchGuestbookException(throwable.getMessage(),
				throwable.getCause());
		}
